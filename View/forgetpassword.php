        ...
        <div class="reset__container-password">
            ...
            <div class="container-resset-pass">
                ...
                <div class="reset_container-notification">
                    <span class="reset_container-notification-text">Chúng tôi sẽ gửi email cho bạn để đặt lại mật
                        khẩu</span>
                </div>

                <div class="reset_container-input">
                    <div class="reset__container-email-id">
                        <label for="" class="reset_container-input-email">Email <span
                                class="reset__container-icon">*</span></label>
                        <input type="text" name="email" class="reset__container-input-email">
                ...
                <div class="reset_container-input-controll">
                    <button name="submit_email" type="submit" class="reset_container-input-controll-btn">Gửi</button>
